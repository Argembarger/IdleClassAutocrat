function idleClassAutocrat() {    
    ...
    if(game.locked().research == false) {
        // To Use Cheat Mode: Comment out any lines that end in // R&D "Non-Cheat"
        if(game.research().patents().length > 0) { // R&D "Non-Cheat"
            if(game.research().active() == true)  { game.research().toggleProduction(); } // R&D "Non-Cheat"
            else { // R&D "Non-Cheat"
        ...
        } else if(game.research().active() == false) { game.research().toggleProduction(); } // R&D "Non-Cheat"
    }
